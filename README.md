...
Цель проекта — продемонстрировать навыки написания автотестов, полученные в рамках курса от QA.GURU.  
Включены **UI и API тесты**, настроен **CI/CD**, **отчёты**, **интеграция с Allure TestOps** и **уведомления в Telegram**.
...
[👉 Посмотреть отчёт](https://Honeylol73.github.io/Diploma_project/)

![Allure Report](media/allure-report.png)
...
[👉 Перейти в Allure TestOps](https://allure.autotests.cloud/project/4988/launches)

![Allure TestOps Dashboard](media/testops-dashboard.png)
...
![Telegram Notification](media/telegram-notification.png)

> Содержит:
> - Статус: 🍾 BRAVO! 🍾/ 💀 FATALITY 💀
> - Количество тестов
...
1. Клонируй репозиторий: git clone https://github.com/Honeylol73/Diploma_project.git
